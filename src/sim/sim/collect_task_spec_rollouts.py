...
def command_for_task_success_wait(
    ...
    params = {
        ...
        "wall_timeout_s": wall_timeout_s,
        "success_margin_m": float(collection.get("success_margin_m", 0.0)),
        "perimeter_success_margin_m": float(collection.get("perimeter_success_margin_m", 5.0)),
        "target_tolerance_m": float(collection.get("target_tolerance_m", 0.5)),
        "max_success_tracking_error_m": float(collection.get("max_success_tracking_error_m", 1.25)),
        "max_progress_tracking_error_m": float(collection.get("max_progress_tracking_error_m", 2.0)),
